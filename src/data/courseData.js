    ...
    modules: [
      {
        ...
        lessons: Array.from({ length: 30 }, (_, index) => {
          ...
          if (day % 2 !== 0) {
            ...
            let quizQuestions = spellingQuizzes[qIdx];
            if (day === 2) {
              quizQuestions = [
              ...
              quizQuestions = [
                { question: 'Please pay the monthly electricity ________ on time.', options: ['Bil', 'Bill', 'Bile', 'Bll'], answer: 1, explanation: "'Bill' is the correct spelling for a statement of charges." },
                { question: 'He studied hard to ________ the final examination.', options: ['Pas', 'Pase', 'Pass', 'Paas'], answer: 2, explanation: "'Pass' is the correct spelling for succeeding in an exam." },
                { question: 'I will ________ you after the meeting ends.', options: ['Call', 'Cal', 'Caul', 'Cale'], answer: 0, explanation: "'Call' is the correct spelling for contact by phone or summon." },
                { question: 'The company suffered a heavy financial ________ this quarter.', options: ['Los', 'Lose', 'Loss', 'Loos'], answer: 2, explanation: "'Loss' is the correct spelling for deficit or failure to keep." },
                { question: 'Our office ________ are very professional and cooperative.', options: ['Staf', 'Staff', 'Staffe', 'Steff'], answer: 1, explanation: "'Staff' is the correct spelling for a group of employees." },
                { question: 'Join the English spelling ________ at 8 PM sharp.', options: ['Clas', 'Classe', 'Class', 'Claas'], answer: 2, explanation: "'Class' is the correct spelling for a course of instruction." },
                { question: 'They ________ high-quality organic goods.', options: ['Sel', 'Sell', 'Selle', 'Cel'], answer: 1, explanation: "'Sell' is the correct spelling for exchange for money." },
                { question: 'Always ________ the exact truth to your team.', options: ['Tel', 'Tell', 'Telle', 'Teal'], answer: 1, explanation: "'Tell' is the correct spelling for speak or communicate." },
                { question: 'Do not let your focus and attention ________.', options: ['Fal', 'Fall', 'Fawl', 'Fale'], answer: 1, explanation: "'Fall' is the correct spelling for drop or decrease." },
                { question: 'The meeting room was ________ of executives.', options: ['Ful', 'Fule', 'Full', 'Fool'], answer: 2, explanation: "'Full' is the correct spelling for containing all that can be held." }
              ];
            } else if (day === 6) {
              quizQuestions = [
                { question: 'I ________ the exact answer to this question.', options: ['Now', 'Know', 'Kno', 'Knaw'], answer: 1, explanation: "'Know' is the correct spelling for having information." },
                { question: 'He injured his right ________ while playing football.', options: ['Nee', 'Knee', 'Knea', 'Kne'], answer: 1, explanation: "'Knee' is the correct spelling for the joint between the thigh and the lower leg." },
                { question: 'Keep the sharp kitchen ________ in a safe place.', options: ['Nife', 'Knife', 'Knif', 'Knaif'], answer: 1, explanation: "'Knife' is the correct spelling for the cutting tool." },
                { question: 'Tie a tight ________ at the end of the rope.', options: ['Not', 'Knott', 'Knot', 'Note'], answer: 2, explanation: "'Knot' is the correct spelling for a fastening made by tying a piece of string or rope." },
                { question: 'Please ________ on the door before entering the room.', options: ['Nock', 'Knock', 'Knok', 'Nok'], answer: 1, explanation: "'Knock' is the correct spelling for striking a surface to attract attention." },
                { question: 'Please ________ your name clearly on the official document.', options: ['Right', 'Write', 'Rite', 'Writte'], answer: 1, explanation: "'Write' is the correct spelling for marking letters/words on paper." },
                { question: 'This calculation gives a completely ________ result.', options: ['Rong', 'Wrong', 'Wraung', 'Wroang'], answer: 1, explanation: "'Wrong' is the correct spelling for incorrect." },
                { question: 'He is wearing a brand-new ________ watch.', options: ['Rist', 'Wrisst', 'Wrist', 'Wryst'], answer: 2, explanation: "'Wrist' is the correct spelling for the joint connecting the hand with the forearm." },
                { question: 'Make sure to ________ the gift box with colored paper.', options: ['Rap', 'Wrap', 'Wrapp', 'Rappe'], answer: 1, explanation: "'Wrap' is the correct spelling for cover or enclose in paper." },
                { question: 'Do not forget to ________ the contract below.', options: ['Sine', 'Syne', 'Sign', 'Cign'], answer: 2, explanation: "'Sign' is the correct spelling for writing your name to authorize something." }
              ];
            } else if (day === 8) {
              quizQuestions = [
                { question: 'We will finalize the audit report by next ________.', options: ['Weak', 'Week', 'Weke', 'Weake'], answer: 1, explanation: "'Week' is the correct spelling for a period of seven days." },
                { question: 'Our project ________ achieved the monthly performance target.', options: ['Teem', 'Team', 'Teme', 'Tiam'], answer: 1, explanation: "'Team' is the correct spelling for a group of players or workers." },
                { question: 'We closed a profitable new business ________ with the client.', options: ['Deel', 'Deal', 'Dele', 'Daal'], answer: 1, explanation: "'Deal' is the correct spelling for a business agreement or transaction." },
                { question: 'The board members will ________ tomorrow morning.', options: ['Meat', 'Meete', 'Meet', 'Mite'], answer: 2, explanation: "'Meet' is the correct spelling for coming together or assembling." },
                { question: 'Please ________ the invoice figures before making payment.', options: ['Chek', 'Check', 'Cheque', 'Ckheck'], answer: 1, explanation: "'Check' is the correct spelling for examining or verifying." },
                { question: 'I ________ we should approve this financial proposal.', options: ['Thinck', 'Think', 'Thinc', 'Thynk'], answer: 1, explanation: "'Think' is the correct spelling for having a belief or opinion." },
                { question: '________ report requires immediate management approval?', options: ['Witch', 'Which', 'Wchich', 'Whitch'], answer: 1, explanation: "'Which' is the correct spelling to ask for a choice among alternatives." },
                { question: 'Always maintain accurate physical ________ records.', options: ['Cashe', 'Cask', 'Cash', 'Cashh'], answer: 2, explanation: "'Cash' is the correct spelling for physical money or currency." },
                { question: '________ does the general meeting officially begin?', options: ['Wen', 'When', 'Whan', 'Whean'], answer: 1, explanation: "'When' is the correct spelling to ask at what time." },
                { question: 'The company agreed to ________ its technical resources.', options: ['Share', 'Shair', 'Shar', 'Shaer'], answer: 0, explanation: "'Share' is the correct spelling for dividing or distributing portion." }
              ];
            } else if (day === 10) {
              quizQuestions = [
                { question: 'Please fill out the official registration ________ carefully.', options: ['From', 'Form', 'Fourm', 'Frome'], answer: 1, explanation: "'Form' is the correct spelling for a document to be filled in." },
                { question: 'He joined an accounting and auditing ________ last month.', options: ['Farm', 'Ferm', 'Firm', 'Phirm'], answer: 2, explanation: "'Firm' is the correct spelling for a business or company." },
                { question: 'Now it is your ________ to present the financial slides.', options: ['Tern', 'Turn', 'Tyrn', 'Tturn'], answer: 1, explanation: "'Turn' is the correct spelling for an opportunity to do something." },
                { question: 'Always ________ the key points in the contract ledger.', options: ['Marc', 'Mark', 'Marke', 'Maark'], answer: 1, explanation: "'Mark' is the correct spelling for write or write a sign." },
                { question: 'Please ________ the physical cash balance before store closing.', options: ['Cownt', 'Count', 'Cowntt', 'Caunt'], answer: 1, explanation: "'Count' is the correct spelling for determine the total number." },
                { question: 'Highlight each critical ________ in the audit report.', options: ['Poynt', 'Point', 'Poinnt', 'Poyint'], answer: 1, explanation: "'Point' is the correct spelling for an item of information or argument." },
                { question: 'The board wants to ________ revenue rapidly this quarter.', options: ['Grow', 'Grou', 'Growe', 'Groe'], answer: 0, explanation: "'Grow' is the correct spelling for increase in size or quantity." },
                { question: 'We plan to ________ five qualified tax associates next month.', options: ['Emploi', 'Employ', 'Employe', 'Emplay'], answer: 1, explanation: "'Employ' is the correct spelling for hiring or using services." },
              ...
              quizQuestions = [
                { question: 'The auditor requested a formal ________ from management.', options: ['Conferm', 'Confirm', 'Confirme', 'Cunfirm'], answer: 1, explanation: "'Confirm' is the correct spelling for establishing the truth or correctness." },
                { question: 'We need to ________ the whole procurement workflow.', options: ['Revise', 'Revize', 'Revaise', 'Revice'], answer: 0, explanation: "'Revise' is the correct spelling for re-examining and improving." },
                { question: 'Management will ________ the final restructuring proposal.', options: ['Acept', 'Accept', 'Axcept', 'Acsept'], answer: 1, explanation: "'Accept' is the correct spelling for consenting to receive." },
                { question: 'The finance manager gave verbal ________ for the payment.', options: ['Concent', 'Consent', 'Consente', 'Consant'], answer: 1, explanation: "'Consent' is the correct spelling for permission for something to happen." },
                { question: 'Please ________ the internal control weaknesses clearly.', options: ['Explane', 'Explain', 'Explayn', 'Explaine'], answer: 1, explanation: "'Explain' is the correct spelling for making something clear." },
                { question: 'The board will ________ the financial viability of the merger.', options: ['Discus', 'Discuss', 'Discusse', 'Discuse'], answer: 1, explanation: "'Discuss' is the correct spelling for talking about something to reach a decision." },
                { question: 'Students must critically ________ the investment proposal.', options: ['Evalute', 'Evaluate', 'Evaluaite', 'Evaluatee'], answer: 1, explanation: "'Evaluate' is the correct spelling for assessing or forming an idea of amount or value." },
                { question: '________ the current year ratios with last year\'s figures.', options: ['Compare', 'Compair', 'Compere', 'Comparee'], answer: 0, explanation: "'Compare' is the correct spelling for estimating, measuring, or noting the similarity or dissimilarity." },
              ...
              quizQuestions = [
                { question: 'Calculate the earnings per ________ before declaring dividends.', options: ['Share', 'Shair', 'Sheare', 'Shar'], answer: 0, explanation: "'Share' is the correct spelling for a portion of ownership." },
                { question: 'The firm generated a high operating cash ________.', options: ['Flowe', 'Flow', 'Floe', 'Flou'], answer: 1, explanation: "'Flow' is the correct spelling for movement or circulation." },
                { question: 'Check the total production ________ per unit.', options: ['Coste', 'Cost', 'Caust', 'Coast'], answer: 1, explanation: "'Cost' is the correct spelling for price or expense." },
                { question: 'Verify the opening cash ________ in the bank ledger.', options: ['Balence', 'Balance', 'Balanse', 'Balaunce'], answer: 1, explanation: "'Balance' is the correct spelling for amount remaining or stable state." },
                { question: 'Both parties signed the legally binding ________.', options: ['Contrack', 'Contract', 'Contrakt', 'Contracte'], answer: 1, explanation: "'Contract' is the correct spelling for a written or spoken agreement." },
                { question: 'The board must follow corporate ________ guidelines.', options: ['Governanse', 'Governance', 'Governnance', 'Governmance'], answer: 1, explanation: "'Governance' is the correct spelling for action or manner of governing." },
                { question: 'The director has an ethical ________ to disclose conflicts.', options: ['Duti', 'Duty', 'Dutey', 'Dutee'], answer: 1, explanation: "'Duty' is the correct spelling for moral or legal obligation." },
                { question: 'Ensure all clauses in the agreement are ________.', options: ['Legel', 'Legal', 'Legall', 'Leagal'], answer: 1, explanation: "'Legal' is the correct spelling for permitted by law." },
                { question: 'The company faced a legal ________ for late delivery.', options: ['Claim', 'Claime', 'Claym', 'Clame'], answer: 0, explanation: "'Claim' is the correct spelling for demand or assertion." },
                { question: 'The manager has full ________ to approve the budget.', options: ['Authoriti', 'Authority', 'Authoraty', 'Authourity'], answer: 1, explanation: "'Authority' is the correct spelling for power or right to give orders." }
              ];
            } else if (day === 30) {
              quizQuestions = [
                { question: 'Both companies reached an agreeable ________ yesterday.', options: ['Settlement', 'Settelment', 'Settlemant', 'Setlement'], answer: 0, explanation: "'Settlement' is the correct spelling for resolution of a dispute or financial account." },
                { question: 'The supplier agreed to ________ the product dispatch.', options: ['Expedite', 'Expydite', 'Expeditte', 'Expidite'], answer: 0, explanation: "'Expedite' is the correct spelling for making an action or process happen sooner or be accomplished more quickly." },
                { question: 'Check the payment terms in the trade ________.', options: ['Agreemant', 'Agreement', 'Agrement', 'Agreament'], answer: 1, explanation: "'Agreement' is the correct spelling for a negotiated and typically legally binding arrangement." },
                { question: 'We settled the commercial ________ through arbitration.', options: ['Disput', 'Dispute', 'Dispyute', 'Dispuite'], answer: 1, explanation: "'Dispute' is the correct spelling for a disagreement or argument." },
                { question: 'Auditors must ________ the physical inventory count.', options: ['Verfy', 'Verify', 'Verifey', 'Verrify'], answer: 1, explanation: "'Verify' is the correct spelling for making sure that something is true, accurate, or justified." },
                { question: 'The CFO will ________ the revised financial statements.', options: ['Authorize', 'Authorise', 'Both A & B are correct', 'Autharize'], answer: 2, explanation: "Both 'Authorize' (US spelling) and 'Authorise' (UK spelling) are correct spellings." },
                { question: 'Ensure total ________ of all material transactions.', options: ['Disclozure', 'Disclosure', 'Discloasure', 'Disclosur'], answer: 1, explanation: "'Disclosure' is the correct spelling for the action of making new or secret information known." },
                { question: 'Please ________ the variance in production overheads.', options: ['Quantifi', 'Quantify', 'Quantifey', 'Qwantify'], answer: 1, explanation: "'Quantify' is the correct spelling for expressing or measuring the quantity of." },
                { question: 'The management decided to ________ the credit limit.', options: ['Modifi', 'Modify', 'Modifey', 'Modefy'], answer: 1, explanation: "'Modify' is the correct spelling for making partial or minor changes to something." },
                { question: 'The consultant will ________ on the proposed tax merger.', options: ['Advise', 'Advice', 'Advize', 'Advicee'], answer: 0, explanation: "'Advise' is the correct spelling for the verb meaning to offer suggestions about the best course of action." }
              ];
            }
            return {
              id: `en-les-${day}`,
    ...
    modules: [
      {
        ...
        description: 'Start with friendly Arabic words, simple phrases, and confidence-building practice.',
          ...
          // Day 16 (Quiz 8)
          {
            ...
            description: 'Practice Arabic furniture vocabulary and Na\'t-Man\'ut rules.',
            langCode: 'ar-SA',
            cards: [],
            phrases: [],
            quiz: [
          ...
          // Day 18 (Quiz 9)
          {
            ...
            quiz: [
              ...
              },
              {
                ...
                options: ['যম্মা (পেশ)', 'কাসরাহ (যের)', 'ফাতহাহ (যবর)', 'সুকুন (জযম)'],
                answer: 1,
              ...
              },
              {
                ...
                options: ['كِتَابُكَ - بَيْتُهُ', 'كِتَابِي - بَيْتُكِ', 'كِتَابُهَا - بَيْتِي', 'كِتَابُهُ - بَيْتُهَا'],
                answer: 0,
              ...
              },
              {
                ...
                options: ['أُمُّهُ', 'أُمُّهَا', 'أُمِّي', 'أُمُّكَ'],
                answer: 1,
              ...
              },
              {
                ...
                options: ['আপনি নামাজ পড়েন', 'আমি নামাজ পড়ি', 'সে নামাজ পড়ে', 'আমরা নামাজ পড়ি'],
                answer: 0,
              ...
              },
              {
                ...
                options: ['أُصَلِّي فِي مَسْجِدِ بِلَالٍ', 'تُصَلِّي فِي مَسْجِدِ بِلَالٍ', 'يُصَلِّي فِي بَيْتِ بِلَالٍ', 'أُصَلِّي مَعَ بِلَالٍ'],
                answer: 0,
              ...
              },
              {
                ...
                options: ['সে দেরিতে ঘুম থেকে জাগে', 'সে খুব ভোরে / তাড়াতাড়ি ঘুম থেকে জাগে', 'সে মসজিদে যায়', 'সে আজান শোনে'],
                answer: 1,
              ...
              },
              {
                ...
                options: ['প্রশ্ন তৈরি করা', 'বর্তমান কালের ক্রিয়াকে নাকরণ করা (আমি আজান শুনি না)', 'আদেশ প্রদান করা', 'অতীত কালের ক্রিয়া গঠন করা'],
                answer: 1,
              ...
              },
              {
                ...
                options: ['আপনার পাশে অ্যালার্ম ঘড়িটি রাখুন', 'অ্যালার্ম ঘড়িটি টেবিলের উপরে রাখুন', 'আপনার ভাই দেরিতে জেগেছে', 'আপনি কি আজান শুনেছেন?'],
                answer: 0,
    ...
    modules: [
      {
        ...
        lessons: IELTS_FOUNDATION_BAND_6_60_CLASSES.map((cls, index) => {
          ...
          return {
            ...
            actionLabel: cls.actionLabel || '',
            actionTarget: cls.actionTarget || '',
            evaluationPrompt: cls.evaluationPrompt || '',
            slideUrl: cls.slideUrl || '',
            slideEmbedUrl: cls.slideEmbedUrl || '',
            practiceBookUrl: cls.practiceBookUrl || '',
            practiceBookEmbedUrl: cls.practiceBookEmbedUrl || '',
            practiceBookTitle: cls.practiceBookTitle || '',
            pdfUrl: cls.pdfUrl || '',
            audioUrl: cls.audioUrl || '',
            audioEmbedUrl: cls.audioEmbedUrl || '',
            audioFileUrl: cls.audioFileUrl || '',
            audioTitle: cls.audioTitle || '',
            questionImageUrl: cls.questionImageUrl || '',
            questionImageFileUrl: cls.questionImageFileUrl || '',
            questionImageTitle: cls.questionImageTitle || '',
            audio2Url: cls.audio2Url || '',
            audio2EmbedUrl: cls.audio2EmbedUrl || '',
